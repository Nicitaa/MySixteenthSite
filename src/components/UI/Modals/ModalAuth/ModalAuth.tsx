...
export function ModalAuth({ isOpen, onClose }: ModalAuthProps) {
    ...
    <>
      ...
      <form onSubmit={(e) => e.preventDefault()} className={`modal-auth-body-forgot`}>
        ...
        <Input
          ...
          label="Login"
          tooltip
          tooltipText="Email or Login"
          type="login"
          icon={BiUser}
          required
        />
        <Button
          className="w-full mx-auto rounded-lg text-xl"
          label="Send email"
          onClick={() => {
            /* BACKEND-Auth-with-credentials */
          }}
        />
        <p>
          Remember your password?{" "}
          <a className={`forgot-password cta-link-primary`} onClick={() => setVariant("LOGIN")}>
      ...
      <form className="modal-auth-body-login" onSubmit={(e) => e.preventDefault()}>
        <div>
          ...
          <div className="login-help">
            <div className="remember-me">
              <input type="checkbox" id="check" checked={checked} onChange={() => setChecked((state) => !state)} />
              <label>
        ...
        <div className="social-auth">
          <SocialButton
            ...
            icon={AiFillGithub}
            onClick={() => {
              /* BACKEND-Social-auth-with-github-provider */
            }}
          />
          <SocialButton
            ...
            icon={BsGoogle}
            onClick={() => {
              /* BACKEND-Social-auth-with-google-provider */
            }}
          />
        </div>
        <p className="text-center">
          Don't have an account?{" "}
          <a className="cta-link-primary" onClick={() => setVariant("REGISTER")}>
            Register
          </a>
        </p>
      </form>
      ...
      <form className="modal-auth-body-register" onSubmit={(e) => e.preventDefault()}>
        ...
        <Button
          ...
          label="Login"
          onClick={() => {
            /* BACKEND-Register-with-credentials */
          }}
        />
        <div className="social-auth">
          <SocialButton
        ...
        <p className="text-center">
          ...
          <a className="cta-link-primary" onClick={() => setVariant("LOGIN")}>
            Login
          </a>
        </p>
      </form>
  ...
  return (
    <ModalContainer
      ...
      header={header}
      headerClassName={`${variant === "FORGOT" && "h-[4rem]"}`}
      body={body}
      bodyClassName={`modal-auth-body
 ...
 `}
      isOpen={isOpen}
      onClose={onClose}
      imgSrc="/public/pages/bg-secondary-reverse.avif"
    />
  )
}
